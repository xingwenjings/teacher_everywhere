...
//QRKe2ES9n6ZpPMui4iyJpaje8EzFsteLmyL39wdWfjtupK97Ue5SylFqLksiDY8H8PncNn9QpvQrBJ1Vgl7yATYmCsQ3wF6i5y4TcYMp0FW5kn1IKBsnW2TJAvZAGg
...
public interface EveryWhereService {
    ...
    Observable<BanmiBean> getLikeData(@Header("banmi-app-token") String token, @Query("page") int page);
    ...
    Observable<BundleBean> getBundle(@Header("banmi-app-token") String token);
