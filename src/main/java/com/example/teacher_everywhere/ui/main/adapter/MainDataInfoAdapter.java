...
public class MainDataInfoAdapter extends RecyclerView.Adapter{
    ...
    public MainDataInfoAdapter(Context context, MainDataInfo.ResultEntity resultEntity) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (viewType == IMAGE_TYPE) {
            ...
            final MainDataInfo.ResultEntity.BanmiEntity banmi = resultEntity.getBanmi();
            ...
            authorHolder.ivHeader.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, BanMiInfoActivity.class);
            ...
            if (list.get(position - 2).getImages() != null && list.get(position - 2).getImages().size() != 0) {
                reviewsHolder.recImgs.setLayoutManager(new LinearLayoutManager(context,LinearLayout.HORIZONTAL,true));
            ...
            likeHolder.showAllContent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                   if (onReViewsClickListener!=null){
                    onReViewsClickListener.onReViewClick(resultEntity.getRoute().getId());
                   }
                }
            });
                ...
                public void onClick(View v) {
                    if (resultEntity.getRoute().isIsCollected()) {
                        if (onItemLikeListener != null) {
                            ...
                            GlideUtil.loadResImage(R.mipmap.back_white, R.mipmap.back_black,
                                    R.mipmap.collect_default, likeHolder.ivLike, context);
    ...
    private OnReViewsClickListener onReViewsClickListener;

    public void setOnReViewsClickListener(OnReViewsClickListener onReViewsClickListener) {
        this.onReViewsClickListener = onReViewsClickListener;
    }

    public interface OnReViewsClickListener{
