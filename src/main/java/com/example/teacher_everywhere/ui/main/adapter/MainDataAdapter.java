...
public class MainDataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (position == 0 && banners.size() > 0) {
            ...
            if (!TextUtils.isEmpty(routes.get(position).getType())&&routes.get(index).getType().equals("bundle")) {
                return BUNDLE_STYLE;
            } else {
                return ITEM_STYLE;
            }
   ...
   private onBundleClickListener onBundleClickListener;
    ...
    public void setOnBundleClickListener(MainDataAdapter.onBundleClickListener onBundleClickListener) {
