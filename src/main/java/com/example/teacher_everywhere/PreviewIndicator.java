package com.example.teacher_everywhere;
...
import com.example.teacher_everywhere.util.SystemUtil;
...
public class PreviewIndicator extends LinearLayout {
    ...
    //选中时对应指示器点的宽度
    public static int chooseSize = 80;//80
    //未选中时指示器点的宽度
    public static int nomalSize = 32;//32
    //指示器高度
